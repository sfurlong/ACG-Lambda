...
def include_display(response_builder):
    ...
    response_builder.set_card(
        ui.StandardCard(
            ...
            text="A Standard Card has text and image.",
            image=ui.Image(
                small_image_url="https://d1yy08fpd1djho.cloudfront.net/travel-small.jpeg",
                large_image_url="https://d1yy08fpd1djho.cloudfront.net/travel-large.jpeg"
            )
        )
    )
